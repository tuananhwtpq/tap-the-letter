...
import com.example.baseproject.databinding.FragmentSetTimeBinding
import com.example.baseproject.utils.SharedPrefManager
import com.example.baseproject.utils.setOnUnDoubleClick

class SetTimeFragment :
    BaseDialogFragment<FragmentSetTimeBinding>(FragmentSetTimeBinding::inflate) {

    private var isExpanded = false
    private var popupWindow: PopupWindow? = null
    private var currentTimeIndex: Int = 0

    val listData = listOf("10S", "20S", "30S")
    ...
    override fun initView() {
        currentTimeIndex = SharedPrefManager.getInt("currentTime", 0)
    ...
    private fun showDropdown() {
        ...
        val adapter = SetTimeAdapter { selectedItem ->
            ...
            SharedPrefManager.putInt("currentTime", index)
